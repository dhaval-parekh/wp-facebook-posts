...
namespace WP_Facebook_Posts\Inc\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the `wp_facebook_posts_singleton_init_{$called_class}` hook to execute code
			 */
			do_action( sprintf( 'wp_facebook_posts_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
